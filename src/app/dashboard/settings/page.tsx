      ...
      <div className="max-w-2xl">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link 
            ...
            className="w-full glass-card rounded-3xl p-6 text-left hover:border-primary/30 transition-all group flex items-center gap-5 bg-zinc-900/50 border-zinc-800"
          >
             <div className="w-14 h-14 rounded-2xl bg-zinc-800 flex items-center justify-center transition-transform group-hover:scale-110">
                <Shield className="w-6 h-6 text-zinc-400 group-hover:text-amber-400 transition-colors" />
             </div>
             <div className="flex-1">
                <p className="font-bold text-lg">Seguridad y Permisos</p>
                <p className="text-sm text-zinc-500 mt-1">Gestiona administradores y sus accesos</p>
             </div>
             <ChevronRight className="w-5 h-5 text-zinc-600 group-hover:text-primary group-hover:translate-x-1 transition-all" />
          </Link>
