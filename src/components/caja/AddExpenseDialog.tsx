...
export function AddExpenseDialog() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-zinc-950 border border-white/10 rounded-3xl w-full max-w-md shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input
                type="text"
                name="description"
                placeholder="Ej. Compra de cuchillas y gel"
