          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar p-8 space-y-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className={cn("p-5 rounded-3xl space-y-1 relative overflow-hidden border", isLight ? "bg-amber-50 border-amber-200" : "bg-amber-500/10 border-amber-500/20")}>
                ...
                <p className="text-[10px] text-amber-500 uppercase tracking-widest font-black flex items-center gap-1.5 relative z-10">Fiar Producto (Consumos)</p>
              ...
              {totals.totalPayments > 0 && (
                <div className={cn("p-5 rounded-3xl space-y-1 relative overflow-hidden border col-span-2", isLight ? "bg-emerald-50 border-emerald-200" : "bg-emerald-500/10 border-emerald-500/20")}>
                  <div className="absolute top-0 right-0 p-4 opacity-10"><ArrowDownLeft className="w-12 h-12 text-emerald-500" /></div>
                  <p className="text-[10px] text-emerald-500 uppercase tracking-widest font-black flex items-center gap-1.5 relative z-10">Abonos (Pagos a Caja)</p>
                  <p className="text-3xl font-black text-emerald-500 relative z-10">+{formatter.format(totals.totalPayments)}</p>
                </div>
              )}
            </div>
            ...
            <div className={cn("p-6 rounded-3xl flex items-center justify-between relative overflow-hidden border", isLight ? "bg-blue-50 border-blue-200" : "bg-muted/20 border-border")}>
              ...
              <div className="relative z-10">
                ...
                <p className="text-xs font-bold text-muted-foreground mt-0.5">Comisión − Vales − Productos + Abonos</p>
              </div>
              <p className={cn(
                "text-3xl font-black relative z-10",
                (commissionValue - totals.totalAdvances - totals.totalConsignments + (totals.totalPayments || 0)) >= 0 ? "text-emerald-500" : "text-red-500"
              )}>
                {formatter.format(commissionValue - totals.totalAdvances - totals.totalConsignments + (totals.totalPayments || 0))}
              </p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'services' && (
          <>
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar pl-8 pr-6 pb-8 pt-6">
              <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground mb-4">Servicios Terminados</h4>
            ...
            {loadingLedger && !ledgerData ? (
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-3 shrink-0">
                  <div className={cn("p-4 rounded-2xl space-y-0.5 border col-span-2", isLight ? "bg-emerald-50/80 border-emerald-200" : "bg-emerald-500/10 border-emerald-500/20")}>
                    <p className="text-[9px] text-emerald-500 uppercase tracking-widest font-black">Saldo Final a Liquidar</p>
                    <p className={cn(
                      "text-2xl font-black",
                      (commissionValue - totals.totalAdvances - totals.totalConsignments + (totals.totalPayments || 0)) >= 0 ? "text-emerald-500" : "text-red-500"
                    )}>
                    ...
                    <p className="text-[9px] text-muted-foreground font-semibold">Ganancias por Servicios − Vales − Fiar Producto + Abonos</p>
                  </div>
                  <div className={cn("p-4 rounded-2xl space-y-0.5 border", isLight ? "bg-blue-50 border-blue-200" : "bg-secondary/30 border-border")}>
                    <p className="text-[9px] text-muted-foreground uppercase tracking-widest font-black">Total Vales (Dinero)</p>
                    <p className="text-base font-black text-red-400">-{formatter.format(totals.totalAdvances)}</p>
                  </div>
                  <div className={cn("p-4 rounded-2xl space-y-0.5 border", isLight ? "bg-blue-50 border-blue-200" : "bg-secondary/30 border-border")}>
                    <p className="text-[9px] text-muted-foreground uppercase tracking-widest font-black">Fiar Producto (Consumos)</p>
                    <p className="text-base font-black text-amber-500">-{formatter.format(totals.totalConsignments)}</p>
                  </div>
                  <div className={cn("p-4 rounded-2xl space-y-0.5 border", isLight ? "bg-blue-50 border-blue-200" : "bg-secondary/30 border-border")}>
                    <p className="text-[9px] text-muted-foreground uppercase tracking-widest font-black">Abonos (Pagos)</p>
                    <p className="text-base font-black text-emerald-500">+{formatter.format(totals.totalPayments)}</p>
                  </div>
                  <div className={cn("p-4 rounded-2xl space-y-0.5 border", isLight ? "bg-blue-50 border-blue-200" : "bg-secondary/30 border-border")}>
                    <p className="text-[9px] text-muted-foreground uppercase tracking-widest font-black">Deducciones Pendientes</p>
                    <p className="text-base font-black text-foreground">{formatter.format(totals.pendingBalance)}</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground mb-2">Movimientos Financieros</h4>
