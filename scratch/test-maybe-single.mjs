...
async function testMaybeSingle() {
  ...
  console.log("conflicts returned:", conflicts);
  console.log("error:", error);
  if (conflicts && conflicts.length > 0) {
    console.log("TEST SUCCESS: Conflict correctly detected!");
  } else {
    console.log("TEST FAILURE: No conflict detected.");
  }
}
